...
const ArticlesHero = ({ /*topics*/ }) => {
  const [showCursor, setShowCursor] = useState([true, true, true]);
      ...
      <HomeHeroContainer>
        <HeadingContainer style={{ maxWidth: `${hero.maxWidth}px` }}>
          <HeroHeading className="mask">
            <Typist
              cursor={showCursor[0] ? '/' : ''}
              onTypingDone={() => setShowCursor([false, true, true])}
            >
              About
            ...
            <Typist
              cursor={showCursor[1] ? '/' : ''}
              onTypingDone={() => setShowCursor([false, false, true])}
              startDelay={400}
            >
              Projects
            ...
            <Typist
              cursor={showCursor[2] ? '/' : ''}
              onTypingDone={() => setShowCursor([false, false, false])}
              startDelay={600}
            >
              Blog
              <Typist.Backspace count={20} />
