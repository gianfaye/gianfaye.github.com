...
const HomeLatest = ({ projects, articles, alwaysShowAllDetails }) => {
  ...
  return (
    ...
    >
      ...
      >
        <ListItem itemType={"featured"} item={articles[4]} narrow={true} />
...
const ListItem = ({ item, itemType, narrow }) => {
  if (!item) return null;
...
const HomeLatestContainer = styled.div`
