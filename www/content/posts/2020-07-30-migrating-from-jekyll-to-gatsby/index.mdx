...
|- src
  ...
  |- sections
    ...
    |- author
  |- templates
    |- article.template.jsx // blog post
    |- articles.template.jsx // index
    |- author.template.jsx // author page
```
...
|- src
  ...
  |- templates
    |- article.template.jsx // blog post
    |- articles.template.jsx // blog listing
    |- author.template.jsx // author page
    |- project.template.jsx // project post based from article.template.jsx
    |- projects.template.jsx // projects listing based from articles.template.jsx
```
...
|- src
  ...
  |- templates
    |- article.template.jsx // blog post
    |- articles.template.jsx // blog listing
    |- topic.template.jsx // topic page
    |- project.template.jsx // project post
    |- projects.template.jsx // projects listing
```
