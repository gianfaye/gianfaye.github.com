...
- [Automated Tax Filing](#tax-filing)
...
If you just want to register the business for now and don't want to hire an accountant or bookkeeper right away, you can have an automated filing for zero income for only 200php per month at [Taxumo](https://www.taxumo.com/). If you join using my referral code `GIANFAYE` you'll get a 5% discount. 😉
